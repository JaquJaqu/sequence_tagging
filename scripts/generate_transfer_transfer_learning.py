...
transtrans=set()
transtrans.add("germeval")
transtrans.add("conll2003")
...
embeddings["facebook_de"]= (300,"/projekte/ocex/martin/embeddings/fasttext/wiki.de.bin")
embeddings["German_de_300"]=(300,"/projekte/ocex/martin/fastText/German_de_docs_skip_300.bin")
...
for train_key in transtrans:
    for trans1_key in transtrans:
      for trans_key,trans_val in train.items():
        for emb_key,(emb_dim,emb_val) in embeddings.items():
            out_dir = "transfer3/transfer_train_"+train_key+"_"+emb_key+"_"+trans1_key+"_"+trans_key
            old_out_dir = "transfer3/transfer_train_"+train_key+"_"+emb_key+"_"+trans1_key
            ...
            param.set("PATH","filename_train","FUCK")
